...
def analyze_contract(text: str) -> dict:
    ...
    - riskItems 배열 각 항목에는 clauseText, riskLevel, reason, guide 포함
    - JSON만 반환하고 추가 설명 금지
