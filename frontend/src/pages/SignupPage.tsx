          ...
          <form onSubmit={handleSubmit}>
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="" disabled>
                    <Typography sx={{ fontSize: '14px', color: colors.gray[400] }}>
                      선택하세요
                    </Typography>
                  </MenuItem>
            ...
            >
              <FormControlLabel
                ...
                label={
                  <Typography sx={{ fontSize: '14px', fontWeight: 600, color: colors.gray[800] }}>
                    전체동의
                  </Typography>
                }
                sx={{ mb: 1 }}
                ...
                <FormControlLabel
                  control={
                    <Checkbox
                      ...
                      onChange={(e) => {
                        setAgreements({ ...agreements, age14: e.target.checked });
